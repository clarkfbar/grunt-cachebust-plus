...
module.exports = function(grunt) {
  ...
  grunt.registerMultiTask('cacheBustPlus', 'Bust static assets from the cache using content hashing', function() {
    ...
    var generateHash = function(fileData) {
      return opts.hash || crypto.createHash(opts.algorithm).update(fileData, opts.encoding).digest('hex');
    };
